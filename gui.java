...
import javax.swing.*;
 ...
 class gui implements ActionListener {
	...
	buttonF.setBounds(10,60,200,25);
	panel.add(buttonF);
	buttonF.addActionListener(this);
	
	buttonC = new JButton("Celsius to Fahrenheits");
	buttonC.setBounds(10,90,200,25);
	panel.add(buttonC);
	...
	private void fahrenheit() {
		...
		goHomeF.setBounds(10,250,200,30);
		panelF.add(goHomeF);
		...
		labelR = new JLabel("");
		labelR.setBounds(10,150,200,30);
		panelF.add(labelR);
	}
	private void celsius() {
		...
		goHomeC.setBounds(10,250,200,30);
		panelC.add(goHomeC);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == button) {
			...
			labelR.setFont(new Font("results", Font.BOLD, 20));
